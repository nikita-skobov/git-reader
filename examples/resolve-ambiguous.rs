...
use git_walker::{printoid, object_database::{LightObjectDB, light_state::{find_matching_oids_loose, LightStateDB, find_matching_oids}, state::MinState}, eprintoid};
...
pub fn realmain() -> io::Result<()> {
    ...
    odb.find_matching_oids(partial_oid, &mut state, |oid| {
