...
pub const fn bitmask(n: usize) -> usize {
    match n {
        B8 =>  0b11111111_00000000,
        B9 =>  0b11111111_10000000,
        B10 => 0b11111111_11000000,
        B11 => 0b11111111_11100000,
        B12 => 0b11111111_11110000,
        B13 => 0b11111111_11111000,
        B14 => 0b11111111_11111100,
        B15 => 0b11111111_11111110,
        B16 => 0b11111111_11111111,
...
pub const fn bitmask_u128(n: usize) -> u128 {
    match n {
...
pub const fn bitshift_u128(n: usize) -> usize {
    match n {
        B8 => 120,
        B9 => 119,
        B10 => 118,
